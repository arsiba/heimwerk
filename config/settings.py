"""
Django settings for heimwerk project.
...
if DEBUG:
    ...
    # Production: Nutze die Datenbank-URL aus der Umgebungsvariable
    # Beispiel-Format: postgres://user:password@host:port/dbname
    DATABASES = {
...
raw_origins = os.getenv("CSRF_TRUSTED_ORIGINS", "http://localhost http://127.0.0.1")
CSRF_TRUSTED_ORIGINS = raw_origins.replace('"', "").replace("'", "").split()
